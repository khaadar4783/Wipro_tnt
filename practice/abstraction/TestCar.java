...
class Car implements Vehicle, FourWheeler {
    @Override
    public void message() {
        // Overriding to resolve the diamond problem (multiple inheritance of default methods)
        // Invoking the message() method of the Vehicle interface using the super keyword
